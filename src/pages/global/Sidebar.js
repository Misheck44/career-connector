                        ...
                        >
                            {
                                userInfo && userInfo.role === 1 ?
                                    <>
                                        ...
                                        <MenuItem component={<Link to="/admin/jobs" />} icon={<WorkIcon />}> Internships </MenuItem>
                                    ...
                                    <>
                                        ...
                                        <MenuItem component={<Link to="/user/jobs" />} icon={<WorkHistoryIcon />}> Applied Internships </MenuItem>
